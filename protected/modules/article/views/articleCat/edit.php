...
<head>
    <title>ECSHOP 管理中心 - 编辑资讯分类 </title>
    ...
    <table cellspacing="1" cellpadding="3" width="100%">
        ...
        <tr>
            ...
            <td>
                <select name="ArticleCat[parent_id]">
                    ...
                    <?php foreach(Yii::app()->memcache->get('catlst') as $k=>$v):$disabled=false;$selected=false;$v['level']>0 ?  $disabled='disabled' : $disabled;$model->parent_id==$v->cat_id ? $selected='selected' : $selected;?>
                        <option <?php echo $disabled;?> <?php echo $selected;?> value="<?php echo $v['cat_id'];?>" ><?php echo str_repeat('&nbsp;',$v->level*8).$v['cat_name'];?></option>
                    <?php  endforeach;?>
                </select>
        ...
        <tr>
            <td align="center" colspan="2"><br>
                ...
                <input type="hidden" name="ArticleCat[cat_id]" value="<?php echo $id?>"/>
            </td>
        </tr>
        </tbody>
    </table>
